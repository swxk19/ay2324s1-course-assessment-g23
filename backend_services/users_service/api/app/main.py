...
from api_models.users import CreateUserRequest, UpdateUserRequest, UpdateUserRoleRequest, UserLoginRequest
...
async def create_user(r: CreateUserRequest):
